...
local extensions = lush(function()
  return {
    ...
    BlinkCmpKindValue           { base.Type },
    BlinkCmpKindStruct          { base.Type },
    BlinkCmpKindTypeParameter   { base.Type },
    BlinkCmpKindEnum            { base.Typedef },
    BlinkCmpKindEnumMember      { base.Typedef },
    BlinkCmpKindClass           { base.Typedef },
